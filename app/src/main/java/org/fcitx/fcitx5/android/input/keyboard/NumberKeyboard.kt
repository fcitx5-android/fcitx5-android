...
class NumberKeyboard(
    ...
    companion object {
        ...
        val Layout: List<List<KeyDef>> = listOf(
            listOf(
                NumPadKey("+", 0xffabu, 0.15f, KeyDef.Appearance.Variant.Alternative),
                NumPadKey("1", 0xffb1u, 0f),
                NumPadKey("2", 0xffb2u, 0f),
                NumPadKey("3", 0xffb3u, 0f),
                NumPadKey("/", 0xffafu, 0.15f, KeyDef.Appearance.Variant.Alternative),
            ),
            listOf(
                NumPadKey("-", 0xffadu, 0.15f, KeyDef.Appearance.Variant.Alternative),
            ...
            listOf(
                NumPadKey("*", 0xffaau, 0.15f, KeyDef.Appearance.Variant.Alternative),
            ...
            listOf(
                ...
                SymbolKey("=", 0.13333f),
                NumPadKey(".", 0xffaeu, variant = KeyDef.Appearance.Variant.Alternative),
                ReturnKey()
            ),
        )
    }
